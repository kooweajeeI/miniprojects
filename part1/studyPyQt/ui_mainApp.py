...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lblMessage.setGeometry(QtCore.QRect(10, 10, 250, 21))
        font = QtGui.QFont()
        font.setFamily("나눔고딕코딩")
        self.lblMessage.setFont(font)
        self.lblMessage.setObjectName("lblMessage")
        self.btnOK = QtWidgets.QPushButton(Form)
        self.btnOK.setGeometry(QtCore.QRect(190, 110, 75, 21))
        self.btnOK.setObjectName("btnOK")
        self.btnPOP = QtWidgets.QPushButton(Form)
        self.btnPOP.setGeometry(QtCore.QRect(110, 110, 71, 21))
